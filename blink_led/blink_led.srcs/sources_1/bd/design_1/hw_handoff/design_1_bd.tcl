...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net blink_led_0_led [get_bd_ports led] [get_bd_pins blink_led_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins blink_led_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
